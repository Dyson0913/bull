package com.netease.protobuf.fieldDescriptors
{
    ...
    final public class RepeatedFieldDescriptor_TYPE_FLOAT extends RepeatedFieldDescriptor
    {

        public function RepeatedFieldDescriptor_TYPE_FLOAT(param1:String, param2:String, param3:uint)
        {
