package com.netease.protobuf.fieldDescriptors
{
    ...
    final public class FieldDescriptor_TYPE_UINT32 extends FieldDescriptor
    {

        public function FieldDescriptor_TYPE_UINT32(param1:String, param2:String, param3:uint)
        {
