package com.netease.protobuf.fieldDescriptors
{
    ...
    final public class RepeatedFieldDescriptor_TYPE_FIXED64 extends RepeatedFieldDescriptor
    {

        public function RepeatedFieldDescriptor_TYPE_FIXED64(param1:String, param2:String, param3:uint)
        {
        ...
        {
            return ReadUtils.read_TYPE_FIXED64(param1);
        }// end function

        override public function writeSingleField(param1:WritingBuffer, param2) : void
        {
            WriteUtils.write_TYPE_FIXED64(param1, param2);
            return;
        }// end function
