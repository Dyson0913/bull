    ...
    final public class ReadUtils extends Object
    {
        ...
        public static function skip(param1:IDataInput, param2:uint) : void
        {
            ...
            switch(param2)
            {
                ...
                {
                    _loc_3 = read_TYPE_UINT32(param1);
                    while (_loc_3 != 0)
                    {
        ...
        public static function read_TYPE_DOUBLE(param1:IDataInput) : Number
        {
            return param1.readDouble();
        }// end function

        public static function read_TYPE_FLOAT(param1:IDataInput) : Number
        {
            return param1.readFloat();
        }// end function

        public static function read_TYPE_INT64(param1:IDataInput) : Int64
        {
            var _loc_3:uint = 0;
        ...
        public static function read_TYPE_UINT64(param1:IDataInput) : UInt64
        {
            var _loc_3:uint = 0;
        ...
        public static function read_TYPE_INT32(param1:IDataInput) : int
        {
            return int(read_TYPE_UINT32(param1));
        }// end function

        public static function read_TYPE_FIXED64(param1:IDataInput) : UInt64
        {
            var _loc_2:* = new UInt64();
        ...
        public static function read_TYPE_FIXED32(param1:IDataInput) : uint
        {
            return param1.readUnsignedInt();
        }// end function

        public static function read_TYPE_BOOL(param1:IDataInput) : Boolean
        {
            return read_TYPE_UINT32(param1) != 0;
        }// end function

        public static function read_TYPE_STRING(param1:IDataInput) : String
        {
            var _loc_2:* = read_TYPE_UINT32(param1);
            return param1.readUTFBytes(_loc_2);
        }// end function

        public static function read_TYPE_BYTES(param1:IDataInput) : ByteArray
        {
            var _loc_2:* = new ByteArray();
            var _loc_3:* = read_TYPE_UINT32(param1);
            if (_loc_3 > 0)
            {
        ...
        public static function read_TYPE_UINT32(param1:IDataInput) : uint
        {
            var _loc_4:uint = 0;
            var _loc_2:uint = 0;
            var _loc_3:uint = 0;
        ...
        public static function read_TYPE_ENUM(param1:IDataInput) : int
        {
            return read_TYPE_INT32(param1);
        }// end function

        public static function read_TYPE_SFIXED32(param1:IDataInput) : int
        {
            return param1.readInt();
        }// end function

        public static function read_TYPE_SFIXED64(param1:IDataInput) : Int64
        {
            var _loc_2:* = new Int64();
            _loc_2.low = param1.readUnsignedInt();
        ...
        public static function read_TYPE_SINT32(param1:IDataInput) : int
        {
            return ZigZag.decode32(read_TYPE_UINT32(param1));
        }// end function

        public static function read_TYPE_SINT64(param1:IDataInput) : Int64
        {
            var _loc_2:Int64 = null;
            _loc_2 = read_TYPE_INT64(param1);
        ...
        public static function read_TYPE_MESSAGE(param1:IDataInput, param2:Message) : Message
        {
            var _loc_3:* = read_TYPE_UINT32(param1);
            ...
            var _loc_5:* = param2;
            _loc_5.used_by_generated_code::readFromSlice(param1, _loc_4);
        ...
        {
            var _loc_4:* = read_TYPE_UINT32(param1);
            if (param1.bytesAvailable < _loc_4)
            {
