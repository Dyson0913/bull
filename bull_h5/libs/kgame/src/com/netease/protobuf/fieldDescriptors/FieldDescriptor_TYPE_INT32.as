package com.netease.protobuf.fieldDescriptors
{
    ...
    final public class FieldDescriptor_TYPE_INT32 extends FieldDescriptor
    {

        public function FieldDescriptor_TYPE_INT32(param1:String, param2:String, param3:uint)
        {
