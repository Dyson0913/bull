package com.netease.protobuf.fieldDescriptors
{
    ...
    final public class FieldDescriptor_TYPE_BYTES extends FieldDescriptor
    {

        public function FieldDescriptor_TYPE_BYTES(param1:String, param2:String, param3:uint)
        {
