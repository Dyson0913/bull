package com.netease.protobuf.fieldDescriptors
{
    ...
    final public class FieldDescriptor_TYPE_DOUBLE extends FieldDescriptor
    {

        public function FieldDescriptor_TYPE_DOUBLE(param1:String, param2:String, param3:uint)
        {
